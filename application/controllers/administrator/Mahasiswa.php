<?php
    class Mahasiswa extends CI_Controller{
        ...
        public function update($id)
        {
            ...
            $data['mahasiswa']  = $this->db->query("select * from mahasiswa mhs, prodi pr where mhs.nama_prodi=pr.nama_prodi and mhs.id='$id'")->result();
            $data['prodi']      = $this->matakuliah_model->tampil_data('prodi')->result();
            $data['detail']     = $this->mahasiswa_model->ambil_data_mahasiswa($id);
        ...
        public function delete($id)
        {
            ...
            $this->jurusan_model->hapus_data($where,'mahasiswa');
