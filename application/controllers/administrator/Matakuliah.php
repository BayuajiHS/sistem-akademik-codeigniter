<?php
    class Matakuliah extends CI_Controller {
        ...
        public function update($id)
        {
            ...
            $data['matakuliah'] = $this->db->query("select * from matakuliah mk, prodi pr where mk.nama_prodi = pr.nama_prodi and mk.kode_matakuliah='$id'")->result();
            $data['prodi']      = $this->matakuliah_model->tampil_data('prodi')->result();
        ...
        public function update_aksi()
        {
            ...
            $this->matakuliah_model->update($where,$data,'matakuliah');
            $this->session->set_flashdata('pesan','<div class="alert alert-success alert-dismissible fade show" role="alert">
