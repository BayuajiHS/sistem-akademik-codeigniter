<div class="container-fluid">
    ...
    <?php echo anchor('administrator/tahun_akademik/tambah_tahunakademik','<button class="btn btn-primary btn-sm mb-3"><i class="fas fa-plus fa-sm"></i> Tambah Tahun Akademik</button>') ?>
