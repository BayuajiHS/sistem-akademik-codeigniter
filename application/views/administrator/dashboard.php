<div class="container-fluid">
    ...
    <div class="alert alert-success" role="alert">
        ...
        <p>Selamat Datang <strong><?php echo $username ?></strong> di Sistem Informasi Akademik Universitas Bayuaji, Anda login sebagai <strong><?php echo $level ?></strong></p>
        <hr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 text-info text-center">
                            <a href="<?php echo base_url() ?>"><p class="nav-link small text-info">CATEGORY</p></a>
